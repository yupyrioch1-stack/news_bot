...
### အဆင့် (၁) - Repository ကို Clone လုပ်ခြင်း
မိမိ Computer တွင် Repository ကို Clone လုပ်ပါ။
```bash
git clone https://github.com/yupyrioch1-stack/news_bot.git
အဆင့် (၂) - Library များ သွင်းခြင်း
Bot အလုပ်လုပ်ရန် လိုအပ်သော Library များကို သွင်းပါ။

Bash
pip install -r requirements.txt
အဆင့် (၃) - GitHub Secrets သတ်မှတ်ခြင်း
GitHub Repo ၏ Settings > Secrets and variables > Actions တွင် အောက်ပါတို့ကို ထည့်ပါ-

TELEGRAM_TOKEN: သင်၏ Bot Token

CHANNEL_ID: သင်၏ Channel Username (ဥပမာ- @my_channel)

အဆင့် (၄) - Workflow Permission ပေးခြင်း
Settings > Actions > General > Workflow permissions တွင် "Read and write permissions" ကို ရွေးပေးပြီး Save နှိပ်ပါ။
...
🏗️ Developed By
Developed & Maintained by @seamap.info

Providing technical solutions for Myanmar Seafarers.
